    ...
    <main id="main">
        ...
        <section id="services" class="services section-bg">
            <div class="container" data-aos="fade-up">
                <div class="section-title">
                    <h2>Layanan Kami</h2>
                    <p>Kami selalu memberikan pelayanan yang terbaik</p>
                </div>
                        ...
                        @foreach ($postData as $post)
                            <div class="swiper-slide p-4">
                                <a href="{{ url('post') . '/' . $post->slug }}"
                                    ...
                                    <div class="card col-12 shadow-pec-success justify-content-center">
                                        <img src="{{ asset('assets/img/posts/' . $post->brosur_url) }}"
                                            class="card-img-top" alt="{{ $post->brosur_url }}">
                                        <div class="card-body">
        ...
        <!-- ======= Portfolio Section ======= -->
        <section id="branch" class="portfolio">
            <div class="container" data-aos="fade-up">
                <div class="section-title">
                    <h2>Portfolio</h2>
                    <p>
