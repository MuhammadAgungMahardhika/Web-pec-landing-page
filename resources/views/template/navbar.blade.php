<nav id="navbar" class="navbar">
    <ul>
        <li>
            <a class="nav-link scrollto active" href="{{ url('/#home') }}">{{ $navbarData[0] }}</a>
        </li>
        ...
        {{-- <li> <a class="nav-link scrollto" href="{{ url('/#branch') }}">{{ $navbarData[5] }}</a> </li> --}}
        ...
        <li><a class="getstarted scrollto" href="#">{{ $navbarData[8] }}</a></li>
